...
public class AssocPlantesRecommandee {
	
	private String nomPlante1;
	private String nomPlante2;
	
	public AssocPlantesRecommandee(String nomPlante1, String nomPlante2) {
		super();
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		AssocPlantesRecommandee other = (AssocPlantesRecommandee) obj;
		if (nomPlante1 == null) {
	...
	public String toString() {
		return "AssocPlantesRecommandee [nomPlante1=" + nomPlante1 + ", nomPlante2=" + nomPlante2 + "]";
	}
	
	public String toStringSpecial() {
		return "AssocPlantesRecommandee: ("+nomPlante1+", "+ nomPlante2+")";
	}
